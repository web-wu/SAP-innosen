...
public class RabbitStaticConstant {
    ...
    public static final String innosen_direct = "innosen.direct";
    public static final String innosen_fanout = "innosen.fanout";
    public static final String innosen_topic = "innosen.topic";
