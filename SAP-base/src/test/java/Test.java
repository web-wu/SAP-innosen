...
//                            .fileOverride() // 覆盖已生成文件
                            .outputDir("C:\\JAVA_E\\Project_study\\SAP-innosen\\SAP-base\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.tabwu.SAP") // 设置父包名
                            .moduleName("base") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "C:\\JAVA_E\\Project_study\\SAP-innosen\\SAP-base\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
